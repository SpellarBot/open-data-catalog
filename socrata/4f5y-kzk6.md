...
| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/facilities-management-closed-cells-as-of-november-4th-2011-b2d1b) |
| Metadata | [Link](https://datacatalog.cookcountyil.gov/api/views/4f5y-kzk6) |
| Data: JSON | [100 Rows](https://datacatalog.cookcountyil.gov/api/views/4f5y-kzk6/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://datacatalog.cookcountyil.gov/api/views/4f5y-kzk6/rows.csv?max_rows=100) |
| Host | datacatalog.cookcountyil.gov |
| Id | 4f5y-kzk6 |
| Name | Facilities Management - Closed Cells as of November 4th, 2011 |
| Attribution | Cook County Department of Facilities Management |
| Category | Finance & Administration |
| Created | 2011-11-23T19:34:21Z |
| Publication Date | 2014-10-09T22:23:31Z |
...
```ls
series e:4f5y-kzk6 d:2011-01-01T00:00:00.000Z t:division_facility=I m:electrician=0 m:cells=608 m:tinsmith=0 m:ironworker=0 m:miscellaneous=0 m:electrician_tech=0 m:brickworker=0 m:glazier=0 m:carpenter=0 m:plumbing=0 m:engineer=0 m:total_cells=0

series e:4f5y-kzk6 d:2011-01-01T00:00:00.000Z t:division_facility=II m:electrician=0 m:tinsmith=0 m:ironworker=0 m:miscellaneous=0 m:electrician_tech=0 m:brickworker=0 m:glazier=0 m:carpenter=0 m:plumbing=0 m:engineer=0 m:total_cells=0

series e:4f5y-kzk6 d:2011-01-01T00:00:00.000Z t:division_facility=III m:electrician=0 m:cells=180 m:tinsmith=0 m:ironworker=0 m:miscellaneous=0 m:electrician_tech=0 m:brickworker=0 m:glazier=0 m:carpenter=0 m:plumbing=0 m:engineer=0 m:total_cells=0
```
...
entity e:4f5y-kzk6 l:"Facilities Management - Closed Cells as of November 4th, 2011" t:attribution="Cook County Department of Facilities Management" t:url=https://datacatalog.cookcountyil.gov/api/views/4f5y-kzk6

property e:4f5y-kzk6 t:meta.view v:id=4f5y-kzk6 v:category="Finance & Administration" v:attributionLink=http://www.cookcountygov.com/portal/server.pt/community/facilities_management/294/facilities_management v:averageRating=0 v:name="Facilities Management - Closed Cells as of November 4th, 2011" v:attribution="Cook County Department of Facilities Management"

property e:4f5y-kzk6 t:meta.view.license v:name="Public Domain"

property e:4f5y-kzk6 t:meta.view.owner v:id=wyzd-r23j v:profileImageUrlMedium=/api/users/wyzd-r23j/profile_images/THUMB v:profileImageUrlLarge=/api/users/wyzd-r23j/profile_images/LARGE v:screenName="Cook County Government" v:profileImageUrlSmall=/api/users/wyzd-r23j/profile_images/TINY v:displayName="Cook County Government"

property e:4f5y-kzk6 t:meta.view.tableauthor v:id=wyzd-r23j v:profileImageUrlMedium=/api/users/wyzd-r23j/profile_images/THUMB v:profileImageUrlLarge=/api/users/wyzd-r23j/profile_images/LARGE v:screenName="Cook County Government" v:profileImageUrlSmall=/api/users/wyzd-r23j/profile_images/TINY v:displayName="Cook County Government"
```
