# Federal Functional Classification (small-scale)

## Dataset

| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/federal-functional-classification-small-scale) |
| Metadata | [Link](https://data.iowa.gov/api/views/3zkm-p5zz) |
| Data: JSON | [100 Rows](https://data.iowa.gov/api/views/3zkm-p5zz/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.iowa.gov/api/views/3zkm-p5zz/rows.csv?max_rows=100) |
| Host | data.iowa.gov |
| Id | 3zkm-p5zz |
| Name | Federal Functional Classification (small-scale) |
| Attribution | Iowa Department of Transportation - Office of Research and Analytics |
| Category | Transportation & Utilities |
| Tags | nhs, network, road, route, transportation, lrs, fcc, federal, functional, asset, classification, iowa dot, iowa department of transportation |
| Created | 2016-11-08T18:09:05Z |
| Publication Date | 2016-11-08T18:14:11Z |

## Description

This layer shows Federal Functional Classes in Iowa for major roads at a smaller scale.
...
entity e:3zkm-p5zz l:"Federal Functional Classification (small-scale)" t:attribution="Iowa Department of Transportation - Office of Research and Analytics" t:url=https://data.iowa.gov/api/views/3zkm-p5zz

property e:3zkm-p5zz t:meta.view v:id=3zkm-p5zz v:category="Transportation & Utilities" v:averageRating=0 v:name="Federal Functional Classification (small-scale)" v:attribution="Iowa Department of Transportation - Office of Research and Analytics"

property e:3zkm-p5zz t:meta.view.owner v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:displayName="Iowa Department of Transportation"

property e:3zkm-p5zz t:meta.view.tableauthor v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:roleName=administrator v:displayName="Iowa Department of Transportation"
```
