# Truck Parking Utilization - Weigh Station

## Dataset

| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/truck-parking-utilization-full-service) |
| Metadata | [Link](https://data.iowa.gov/api/views/pcia-gz2m) |
| Data: JSON | [100 Rows](https://data.iowa.gov/api/views/pcia-gz2m/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.iowa.gov/api/views/pcia-gz2m/rows.csv?max_rows=100) |
| Host | data.iowa.gov |
| Id | pcia-gz2m |
| Name | Truck Parking Utilization - Weigh Station |
...
| Created | 2016-08-19T20:27:51Z |
| Publication Date | 2016-08-19T20:29:17Z |

## Description

Iowa Department of Transportation statewide rest area data. This layer displays truck parking locations with weigh stations.
...
entity e:pcia-gz2m l:"Truck Parking Utilization - Weigh Station" t:attribution="Iowa DOT, HDR Engineering" t:url=https://data.iowa.gov/api/views/pcia-gz2m

property e:pcia-gz2m t:meta.view v:id=pcia-gz2m v:category="Transportation & Utilities" v:averageRating=0 v:name="Truck Parking Utilization - Weigh Station" v:attribution="Iowa DOT, HDR Engineering"

property e:pcia-gz2m t:meta.view.owner v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:displayName="Iowa Department of Transportation"

property e:pcia-gz2m t:meta.view.tableauthor v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:roleName=administrator v:displayName="Iowa Department of Transportation"
```
