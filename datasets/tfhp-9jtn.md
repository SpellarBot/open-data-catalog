# Rest Areas - Full Service in Iowa

## Dataset

| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/rest-areas-full-service-in-iowa) |
| Metadata | [Link](https://data.iowa.gov/api/views/tfhp-9jtn) |
| Data: JSON | [100 Rows](https://data.iowa.gov/api/views/tfhp-9jtn/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.iowa.gov/api/views/tfhp-9jtn/rows.csv?max_rows=100) |
| Host | data.iowa.gov |
| Id | tfhp-9jtn |
| Name | Rest Areas - Full Service in Iowa |
| Attribution | Iowa DOT, HDR Engineering |
| Category | Transportation & Utilities |
| Tags | asset, classification, rest, area, iowa dot, iowa department of transportation |
| Created | 2016-08-19T19:53:48Z |
| Publication Date | 2016-08-19T20:03:26Z |

## Description

Iowa Department of Transportation statewide rest area data. This layer displays full service rest areas in Iowa.
...
entity e:tfhp-9jtn l:"Rest Areas - Full Service in Iowa" t:attribution="Iowa DOT, HDR Engineering" t:url=https://data.iowa.gov/api/views/tfhp-9jtn

property e:tfhp-9jtn t:meta.view v:id=tfhp-9jtn v:category="Transportation & Utilities" v:averageRating=0 v:name="Rest Areas - Full Service in Iowa" v:attribution="Iowa DOT, HDR Engineering"

property e:tfhp-9jtn t:meta.view.owner v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:displayName="Iowa Department of Transportation"

property e:tfhp-9jtn t:meta.view.tableauthor v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:roleName=administrator v:displayName="Iowa Department of Transportation"
```
