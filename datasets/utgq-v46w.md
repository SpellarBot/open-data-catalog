...
* [Dataset URL](https://data.medicare.gov/api/views/utgq-v46w/rows.json?max_rows=100)
* [Catalog URL](https://catalog.data.gov/dataset/patient-survey-ich-cahps-national)
* [Metadata URL](https://data.medicare.gov/api/views/utgq-v46w)
* Id = utgq-v46w
...
| Country                                                                       | country                                                                       | text      | text        | series tag     | Yes      | 
| Lower box percent of patients nephrologists? communication and caring         | lower_box_percent_of_patients_nephrologists_communication_and_caring          | number    | text        | numeric metric | Yes      | 
| Middle box percent of patients nephrologists? communication and caring        | middle_box_percent_of_patients_nephrologists_communication_and_caring         | number    | text        | numeric metric | Yes      | 
| Top box percent of patients nephrologists? communication and caring           | top_box_percent_of_patients_nephrologists_communication_and_caring            | number    | text        | numeric metric | Yes      | 
| Lower box percent of patients-quality of dialysis center care and operations  | lower_box_percent_of_patients_quality_of_dialysis_center_care_and_operations  | number    | text        | numeric metric | Yes      | 
| Middle box percent of patients-quality of dialysis center care and operations | middle_box_percent_of_patients_quality_of_dialysis_center_care_and_operations | number    | text        | numeric metric | Yes      | 
| Top box percent of patients-quality of dialysis center care and operations    | top_box_percent_of_patients_quality_of_dialysis_center_care_and_operations    | number    | text        | numeric metric | Yes      | 
| Lower box percent of patients-providing information to patients               | lower_box_percent_of_patients_providing_information_to_patients               | number    | text        | numeric metric | Yes      | 
| Top box percent of patients providing information to patients                 | top_box_percent_of_patients_providing_information_to_patients                 | number    | text        | numeric metric | Yes      | 
| Lower box percent of patients-rating of the nephrologist                      | lower_box_percent_of_patients_rating_of_the_nephrologist                      | number    | text        | numeric metric | Yes      | 
| Middle box percent of patients- rating of the nephrologist                    | middle_box_percent_of_patients_rating_of_the_nephrologist                     | number    | text        | numeric metric | Yes      | 
| Top box percent of patients- rating of the nephrologist                       | top_box_percent_of_patients_rating_of_the_nephrologist                        | number    | text        | numeric metric | Yes      | 
| Lower box percent of patients-rating of the dialysis center staff             | lower_box_percent_of_patients_rating_of_the_dialysis_center_staff             | number    | text        | numeric metric | Yes      | 
| Middle box percent of patients-rating of the dialysis center staff            | middle_box_percent_of_patients_rating_of_the_dialysis_center_staff            | number    | text        | numeric metric | Yes      | 
| Top box percent of patients-rating of the dialysis center staff               | top_box_percent_of_patients_rating_of_the_dialysis_center_staff               | number    | text        | numeric metric | Yes      | 
| Lower box percent of patients-rating of the dialysis facility                 | lower_box_percent_of_patients_rating_of_the_dialysis_facility                 | number    | text        | numeric metric | Yes      | 
| Middle box percent of patients-rating of the dialysis facility                | middle_box_percent_of_patients_rating_of_the_dialysis_facility                | number    | text        | numeric metric | Yes      | 
| Top box percent of patients-rating of the dialysis facility                   | top_box_percent_of_patients_rating_of_the_dialysis_facility                   | number    | text        | numeric metric | Yes      | 
```
...
property e:utgq-v46w t:meta.view d:2017-03-08T00:55:29.726Z v:id=utgq-v46w v:category="Dialysis Facility Compare" v:averageRating=0 v:name="Patient survey (ICH-CAHPS) - National"

property e:utgq-v46w t:meta.view.owner d:2017-03-08T00:55:29.726Z v:id=drs7-75yr v:profileImageUrlMedium=/api/users/drs7-75yr/profile_images/THUMB v:profileImageUrlLarge=/api/users/drs7-75yr/profile_images/LARGE v:screenName=cms v:profileImageUrlSmall=/api/users/drs7-75yr/profile_images/TINY v:roleName=administrator v:displayName=cms

property e:utgq-v46w t:meta.view.tableauthor d:2017-03-08T00:55:29.726Z v:id=drs7-75yr v:profileImageUrlMedium=/api/users/drs7-75yr/profile_images/THUMB v:profileImageUrlLarge=/api/users/drs7-75yr/profile_images/LARGE v:screenName=cms v:profileImageUrlSmall=/api/users/drs7-75yr/profile_images/TINY v:roleName=administrator v:displayName=cms

property e:utgq-v46w t:meta.view.metadata.custom_fields.common_core d:2017-03-08T00:55:29.726Z v:Publisher="Centers for Medicare & Medicaid Services (CMS)" v:Contact_Email=DialysisData@umich.edu v:Contact_Name=CMS v:Bureau_Code=009:38 v:Program_Code=009:078
```