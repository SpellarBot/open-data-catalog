...
| Yes      | time           | latest_record_update                                                                                  | Latest Record Update                                                                                                  | calendar_date | calendar_date |
...
| No       |                | registration_expiration_date                                                                          | Registration Expiration Date                                                                                          | text          | calendar_date |
| No       |                | initial_registration_date                                                                             | Initial Registration Date                                                                                             | text          | calendar_date |
| Yes      | numeric metric | current_registration_fee                                                                              | Current Registration Fee                                                                                              | money         | money         |
| No       |                | identification_inspection_date                                                                        | Identification Inspection Date                                                                                        | text          | calendar_date |
...
| No       |                | most_recent_maintenance_notice_of_violation_date                                                      | Most Recent Maintenance Notice of Violation Date                                                                      | text          | calendar_date |
| No       |                | most_recent_maintenance_inspection_date                                                               | Most Recent Maintenance Inspection Date                                                                               | text          | calendar_date |
| No       |                | maintenance_re_inspection_date                                                                        | Maintenance Re-Inspection Date                                                                                        | text          | calendar_date |
...
| No       |                | original_maintenance_ct_date                                                                          | Original Maintenance CT Date                                                                                          | text          | calendar_date |
| Yes      | series tag     | court_notes                                                                                           | Court Notes                                                                                                           | text          | text          |
| No       |                | most_recent_registry_notice_of_violation_date                                                         | Most Recent Registry Notice of Violation Date                                                                         | text          | calendar_date |
| Yes      | series tag     | registry_court_case_number                                                                            | Registry Court Case Number                                                                                            | text          | text          |
| No       |                | original_registry_ct_date                                                                             | Original Registry CT Date                                                                                             | text          | calendar_date |
...
| No       |                | registration_anniversary_date                                                                         | Registration Anniversary Date                                                                                         | text          | calendar_date |
| No       |                | last_payment_date                                                                                     | Last Payment Date                                                                                                     | text          | calendar_date |
