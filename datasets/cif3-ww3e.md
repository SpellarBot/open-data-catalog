...
| No       |                | year_of_appliance_manufacture                                                                       | Year of Appliance Manufacture                                                                       | text      | text        |
...
| No       |                | dhw_manufacture_year                                                                                | DHW Manufacture Year                                                                                | text      | text        |
...
| No       |                | year_hvac_cooling_unit_was_manufactured                                                             | Year HVAC Cooling Unit was Manufactured                                                             | text      | text        |
...
| No       |                | year_hvac_heating_unit_was_manufactured                                                             | Year HVAC Heating Unit was Manufactured                                                             | text      | text        |
...
```ls
Excluded Fields = dishwasher_usage_pattern_cycles_week,clothes_washer_usage_pattern_loads_week,year_of_appliance_manufacture,dhw_manufacture_year,year_hvac_cooling_unit_was_manufactured,year_hvac_heating_unit_was_manufactured
```
...
property e:cif3-ww3e t:meta.view.owner v:id=xzik-pf59 v:profileImageUrlMedium=/api/users/xzik-pf59/profile_images/THUMB v:profileImageUrlLarge=/api/users/xzik-pf59/profile_images/LARGE v:screenName="NY Open Data" v:profileImageUrlSmall=/api/users/xzik-pf59/profile_images/TINY v:roleName=publisher v:displayName="NY Open Data"
