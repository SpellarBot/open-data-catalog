...
```ls
Excluded Fields = year_of_appliance_manufacture,dishwasher_usage_pattern_cycles_week,clothes_washer_usage_pattern_loads_week,dhw_manufacture_year,year_hvac_cooling_unit_was_manufactured,year_hvac_heating_unit_was_manufactured
```
