...
| Yes      | series tag     | permit_address_text          | PERMIT_ADDRESS_TEXT          | text       | text        |
| Yes      | series tag     | permit_stat                  | PERMIT_STAT                  | text       | text        |
| Yes      | series tag     | permit_address_stno          | PERMIT_ADDRESS_STNO          | text       | text        |
| Yes      | series tag     | permit_address_predir        | PERMIT_ADDRESS_PREDIR        | text       | text        |
| Yes      | series tag     | permit_address_stname        | PERMIT_ADDRESS_STNAME        | text       | text        |
| Yes      | series tag     | permit_address_suffix        | PERMIT_ADDRESS_SUFFIX        | text       | text        |
| Yes      | series tag     | permit_address_postdir       | PERMIT_ADDRESS_POSTDIR       | text       | text        |
| Yes      | series tag     | permit_address_stsub         | PERMIT_ADDRESS_STSUB         | text       | text        |
...
| Yes      | numeric metric | address_key                  | ADDRESS_KEY                  | number     | number      |
...
```ls
Excluded Fields = unimp_row_start_dt,filler_start_dt,filler_intrmt_cls_end_dt,prkln_intrmt_cls_end_dt,strt_close_start_dt,unimp_row_part_cls_end_dt,unimp_row_end_dt,strt_reroute_start_dt,strt_intrmt_close_end_dt,intersect_reroute_end_dt,plntstrp_start_dt,bike_lane_intrmt_cls_strt_dt,plntstrp_intrmt_cls_strt_dt,prkln_close_start_dt,alley_close_start_dt,plntstrp_end_dt,trvl_lane_intrmt_cls_strt_dt,sdwlk_reroute_end_dt,bike_lane_reroute_end_dt,sdwlk_reroute_start_dt,strt_part_close_start_dt,bike_lane_part_cls_end_dt,trvl_lane_intrmt_cls_end_dt,trvl_lane_part_cls_end_dt,sdwlk_close_start_dt,strt_close_end_dt,use_exp_date,sdwlk_part_close_start_dt,strt_part_close_end_dt,plntstrp_reroute_end_dt,trvl_lane_part_cls_strt_dt,bike_lane_end_dt,intersect_intrmt_cls_end_dt,unimp_row_part_cls_strt_dt,intersect_intrmt_cls_strt_dt,plntstrp_reroute_start_dt,bike_lane_intrmt_cls_end_dt,filler_reroute_start_dt,sdwlk_intrmt_close_strt_dt,unimp_row_intrmt_cls_strt_dt,strt_reroute_end_dt,prkln_reroute_end_dt,filler_part_close_end_dt,alley_reroute_end_dt,sdwlk_intrmt_close_end_dt,filler_reroute_end_dt,intersect_part_close_end_dt,strt_intrmt_close_start_dt,prkln_close_end_dt,alley_part_close_end_dt,trvl_lane_reroute_end_dt,unimp_row_intrmt_cls_end_dt,intersect_part_close_strt_dt,filler_part_close_start_dt,sdwlk_part_cls_end_dt,use_start_date,bike_lane_reroute_start_dt,filler_end_dt,alley_close_end_dt,alley_intrmt_close_end_dt,alley_intrmt_close_start_dt,intersect_start_dt,unimp_row_reroute_start_dt,plntstrp_part_cls_start_dt,prkln_part_cls_start_dt,prkln_intrmt_cls_strt_dt,filler_intrmt_cls_strt_dt,alley_reroute_start_dt,prkln_part_cls_end_dt,plntstrp_part_cls_end_dt,plntstrp_intrmt_cls_end_dt,bike_lane_part_cls_strt_dt,alley_part_close_start_dt,intersect_reroute_start_dt,trvl_lane_end_dt,intersect_end_dt,unimp_row_reroute_end_dt,review_action_date,trvl_lane_start_dt,sdwlk_close_end_dt,bike_lane_start_dt,prkln_reroute_start_dt,trvl_lane_reroute_start_dt
```
