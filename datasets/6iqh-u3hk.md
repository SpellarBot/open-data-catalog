...
| No       |                | rpt_date            | Rpt_Date            | text      | calendar_date |
| No       |                | from_date           | From_Date           | text      | calendar_date |
| No       |                | thru_date           | Thru_Date           | text      | calendar_date |
| No       |                | elect_date          | Elect_Date          | text      | calendar_date |
...
| No       |                | expn_date           | Expn_Date           | text      | calendar_date |
...
property e:6iqh-u3hk t:meta.view.owner v:id=vm9c-ykir v:profileImageUrlMedium=/api/users/vm9c-ykir/profile_images/THUMB v:profileImageUrlLarge=/api/users/vm9c-ykir/profile_images/LARGE v:screenName="Steven Massey" v:profileImageUrlSmall=/api/users/vm9c-ykir/profile_images/TINY v:displayName="Steven Massey"
