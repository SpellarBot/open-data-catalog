...
| Rows Updated | 2017-03-18T08:02:05Z |
...
| No       |             | vehicle_model_year                | Vehicle Model Year                | text      | number      |
...
```ls
Excluded Fields = address,vehicle_model_year
```

## Data Commands

```ls
series e:tfm3-3j95 d:2015-08-25T01:01:25.000Z t:vehicle_color=WHITE t:public_vehicle_number=7418 t:zip_code=60448 t:company_name="ELITE MEDICAL TRANSPORTATION LLC" t:vehicle_type=Medicar t:status=ACTIVE t:vehicle_model=E350 t:state=IL t:wheelchair_accessible=N t:vehicle_make=FORD t:record_id=7418Medicar t:city=MOKENA t:vehicle_fuel_source=Gasoline m:row_number.tfm3-3j95=1
