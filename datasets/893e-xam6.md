...
| Rows Updated | 2017-03-14T08:11:56Z |
...
| Yes      | series tag     | permit_date_approved                        | Permit Date Approved                        | calendar_date | calendar_date |
| Yes      | series tag     | inspection_number                           | Inspection Number                           | text          | number        |
| Yes      | series tag     | expiration_date                             | Expiration Date                             | calendar_date | calendar_date |
...
| Yes      | series tag     | inspection_date                             | Inspection Date                             | calendar_date | calendar_date |
| Yes      | series tag     | hearing_calendar_date                       | Hearing Calendar Date                       | calendar_date | calendar_date |
...
| Yes      | time           | date_all_permit_fees_were_paid              | Date all permit fees were paid              | calendar_date | calendar_date |
...
```ls
Value = date_all_permit_fees_were_paid
...
```ls
Excluded Fields = permit_address,permit_application_date
```

## Data Commands

```ls
series e:893e-xam6 d:2005-07-28T00:00:00.000Z t:permit_type=152 t:station_area=07 t:neighborhood_district=Mission t:permit_holder="Tacos Santana" t:night_place_of_assembly_permit=false t:bureau_of_fire_prevention_district=06 t:supervisor_district=9 t:permit_number=7199 t:permit_zipcode=94110 t:permit_type_description="liquefied petroleum gas, mobile caterer, use" t:permit_date_approved=2005-07-28T00:00:00 t:permit_status="closed (permit)" t:dba_name_associated_with_this_permit_holder="Tacos Santana" t:tax_class=D19 t:expiration_date=2009-12-31T00:00:00 t:battalion=06 m:posting_fee=0 m:referral_fee=0 m:permit_fee=160

series e:893e-xam6 d:2007-01-12T00:00:00.000Z t:permit_type=826 t:station_area=03 t:neighborhood_district="Nob Hill" t:permit_holder="Golden Gate Tank Removal" t:night_place_of_assembly_permit=false t:bureau_of_fire_prevention_district=04 t:supervisor_district=3 t:permit_number=13269 t:permit_zipcode=94109 t:permit_type_description="under-ground stationary tank, abandon-in-place" t:inspection_number=31075 t:permit_date_approved=2007-01-12T00:00:00 t:permit_status=expired t:dba_name_associated_with_this_permit_holder="Golden Gate Tank Removal" t:expiration_date=2007-04-13T00:00:00 t:battalion=04 t:unit_type=gallons m:posting_fee=0 m:unit_count=1500 m:referral_fee=0 m:permit_fee=180

series e:893e-xam6 d:2010-09-16T00:00:00.000Z t:permit_number=29770 t:permit_type=100I t:permit_type_description="conditional use, vendor, iscott" t:permit_date_approved=2010-09-25T00:00:00 t:permit_status=expired t:dba_name_associated_with_this_permit_holder="Special Events/street Fairs" t:expiration_date=2010-09-27T00:00:00 t:battalion=01 t:permit_holder="Steven Restivo Event Services" t:night_place_of_assembly_permit=false m:posting_fee=0 m:referral_fee=0 m:permit_fee=0
```
