...
| Yes      | numeric metric | mpozip      | MPOZIP     | number     | number      |
...
| Yes      | numeric metric | dtpzip      | DTPZIP     | number     | number      |
...
```ls
series e:82yg-8mf6 d:1970-01-01T00:00:00.000Z t:dtpcity="Cedar Rapids" t:mpoemail=c.butterfield@cedar-rapids.org t:mpoabbr=CMPO t:mpocity="Cedar Rapids" t:mponame="Corridor Metropolitan Planning Organization" t:mpourl=http://www.corridormpo.com/ t:mpostate=IA t:mpostr="3851 River Ridge Drive NE" t:dtppob=NA t:mpodtp="Catherine Cutler" t:dtpemail=catherine.cutler@dot.iowa.gov t:dtpstr="430 16th Avenue, SW" t:mpopob=NA t:objectid=1 m:dtpzip=52404 m:shape_area=842740282.44666 m:dtpdis=6 m:mpozip=52402

series e:82yg-8mf6 d:1970-01-01T00:00:00.000Z t:dtpcity="Cedar Rapids" t:mpoemail=john-yapp@iowa-city.org t:mpoabbr=MPOJC t:mpocity="Iowa City" t:mponame="Metropolitan Planning Organization of Johnson County" t:mpourl=http://www.mpojc.org/ t:mpostate=IA t:mpostr="410 East Washington Street" t:dtppob=NA t:mpodtp="Catherine Cutler" t:dtpemail=catherine.cutler@dot.iowa.gov t:dtpstr="430 16th Avenue, SW" t:mpopob=NA t:objectid=2 m:dtpzip=52404 m:shape_area=251322956.34375 m:dtpdis=6 m:mpozip=52240

series e:82yg-8mf6 d:1970-01-01T00:00:00.000Z t:dtpcity=Ames t:mpoemail=DMAMPO@dmampo.org t:mpoabbr=DMAMPO t:mpocity="Des Moines" t:mponame="Des Moines Area Metropolitan Planning Organization" t:mpourl=http://www.dmampo.org/ t:mpostate=IA t:mpostr="6200 Aurora Avenue, Suite 300W" t:dtppob=NA t:mpodtp="Mike Clayton" t:dtpemail=mike.clayton@dot.iowa.gov t:dtpstr="1020 S. Fourth St" t:mpopob=NA t:objectid=3 m:dtpzip=50010 m:shape_area=1429165212.79525 m:dtpdis=1 m:mpozip=50322
```

## Meta Commands

```ls
metric m:mpozip p:integer l:MPOZIP d:"MPO Zip Code" t:dataTypeName=number

metric m:dtpzip p:integer l:DTPZIP d:"District Trans. Planner Zip Code" t:dataTypeName=number
