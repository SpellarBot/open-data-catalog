# SICL Intersections - Top 200

## Dataset

| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/sicl-intersections-top-200) |
| Metadata | [Link](https://data.iowa.gov/api/views/xhwi-zejh) |
| Data: JSON | [100 Rows](https://data.iowa.gov/api/views/xhwi-zejh/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.iowa.gov/api/views/xhwi-zejh/rows.csv?max_rows=100) |
| Host | data.iowa.gov |
| Id | xhwi-zejh |
| Name | SICL Intersections - Top 200 |
...
| Created | 2016-06-09T20:53:19Z |
| Publication Date | 2016-06-09T21:00:02Z |

## Description

Top 200 intersection safety improvement candidate locations in Iowa (composite rank).  
...
metric m:ratenorm p:float l:RATENORM d:"Rate Values - Crash Rate Normalized" t:dataTypeName=number
...
entity e:xhwi-zejh l:"SICL Intersections - Top 200" t:attribution="Iowa Department of Transportation - Office of Traffic & Safety" t:url=https://data.iowa.gov/api/views/xhwi-zejh

property e:xhwi-zejh t:meta.view v:id=xhwi-zejh v:category="Transportation & Utilities" v:attributionLink=https://gis.iowadot.gov/public/rest/services/Traffic_Safety/SICL/MapServer/0 v:averageRating=0 v:name="SICL Intersections - Top 200" v:attribution="Iowa Department of Transportation - Office of Traffic & Safety"

property e:xhwi-zejh t:meta.view.owner v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:displayName="Iowa Department of Transportation"

property e:xhwi-zejh t:meta.view.tableauthor v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:roleName=administrator v:displayName="Iowa Department of Transportation"
```
