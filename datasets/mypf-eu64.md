...
| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/draft-data) |
| Metadata | [Link](https://data.nola.gov/api/views/mypf-eu64) |
| Data: JSON | [100 Rows](https://data.nola.gov/api/views/mypf-eu64/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.nola.gov/api/views/mypf-eu64/rows.csv?max_rows=100) |
| Host | data.nola.gov |
| Id | mypf-eu64 |
| Name | ResultsNOLA (2016) |
| Created | 2016-07-08T16:25:42Z |
| Publication Date | 2016-09-09T21:52:02Z |

## Description

This data includes all of the key performance indicators for ResultsNOLA, the City's performance management report. It is connected to the 2016 goal tiles on results.nola.gov.
...
entity e:mypf-eu64 l:"ResultsNOLA (2016)" t:url=https://data.nola.gov/api/views/mypf-eu64

property e:mypf-eu64 t:meta.view v:id=mypf-eu64 v:averageRating=0 v:name="ResultsNOLA (2016)"

property e:mypf-eu64 t:meta.view.owner v:id=ii98-542e v:screenName=mschigoda v:displayName=mschigoda

property e:mypf-eu64 t:meta.view.tableauthor v:id=ii98-542e v:screenName=mschigoda v:roleName=publisher v:displayName=mschigoda

property e:mypf-eu64 t:meta.view.metadata.custom_fields.common_core v:Contact_Email=maschigoda@nola.gov
```
