...
| No       |                | hire_date            | CURRENT HIRE DATE    | text      | calendar_date |
| No       |                | end_date             | EMPLOYMENT END DATE  | text      | calendar_date |
