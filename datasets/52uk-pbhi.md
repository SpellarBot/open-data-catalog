...
| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/2013-proposed-budget-attachment-a-0c64f) |
| Metadata | [Link](https://data.seattle.gov/api/views/52uk-pbhi) |
| Data: JSON | [100 Rows](https://data.seattle.gov/api/views/52uk-pbhi/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.seattle.gov/api/views/52uk-pbhi/rows.csv?max_rows=100) |
| Host | data.seattle.gov |
| Id | 52uk-pbhi |
| Name | 2013 Proposed Budget Attachment A |
| Attribution | City Budget Office |
| Category | Finance |
| Tags | 2013 proposed budget |
| Created | 2012-09-25T16:20:45Z |
| Publication Date | 2012-09-25T16:24:29Z |
...
entity e:52uk-pbhi l:"2013 Proposed Budget Attachment A" t:attribution="City Budget Office" t:url=https://data.seattle.gov/api/views/52uk-pbhi

property e:52uk-pbhi t:meta.view v:id=52uk-pbhi v:category=Finance v:averageRating=0 v:name="2013 Proposed Budget Attachment A" v:attribution="City Budget Office"

property e:52uk-pbhi t:meta.view.owner v:id=tdaq-haqd v:screenName="Brandon Johns" v:displayName="Brandon Johns"

property e:52uk-pbhi t:meta.view.tableauthor v:id=tdaq-haqd v:screenName="Brandon Johns" v:roleName=publisher v:displayName="Brandon Johns"
```
