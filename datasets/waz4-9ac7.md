# Truck Parking Locations - Full Service

## Dataset

| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/truck-parking-locations-full-service) |
| Metadata | [Link](https://data.iowa.gov/api/views/waz4-9ac7) |
| Data: JSON | [100 Rows](https://data.iowa.gov/api/views/waz4-9ac7/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.iowa.gov/api/views/waz4-9ac7/rows.csv?max_rows=100) |
| Host | data.iowa.gov |
| Id | waz4-9ac7 |
| Name | Truck Parking Locations - Full Service |
...
| Created | 2016-08-19T20:18:46Z |
| Publication Date | 2016-08-19T20:21:21Z |

## Description

Iowa Department of Transportation statewide rest area data. This layer displays full service locations with truck parking.
...
entity e:waz4-9ac7 l:"Truck Parking Locations - Full Service" t:attribution="Iowa DOT, HDR Engineering" t:url=https://data.iowa.gov/api/views/waz4-9ac7

property e:waz4-9ac7 t:meta.view v:id=waz4-9ac7 v:category="Transportation & Utilities" v:averageRating=0 v:name="Truck Parking Locations - Full Service" v:attribution="Iowa DOT, HDR Engineering"

property e:waz4-9ac7 t:meta.view.owner v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:displayName="Iowa Department of Transportation"

property e:waz4-9ac7 t:meta.view.tableauthor v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:roleName=administrator v:displayName="Iowa Department of Transportation"
```
