# Truck Parking Locations - Alternative Service Location

## Dataset

| Name | Value |
| :--- | :---- |
| Catalog | [Link](https://catalog.data.gov/dataset/truck-parking-locations-alternative-service-location) |
| Metadata | [Link](https://data.iowa.gov/api/views/p594-nfrt) |
| Data: JSON | [100 Rows](https://data.iowa.gov/api/views/p594-nfrt/rows.json?max_rows=100) |
| Data: CSV | [100 Rows](https://data.iowa.gov/api/views/p594-nfrt/rows.csv?max_rows=100) |
| Host | data.iowa.gov |
| Id | p594-nfrt |
| Name | Truck Parking Locations - Alternative Service Location |
...
| Created | 2016-08-19T20:15:41Z |
| Publication Date | 2016-08-19T20:18:26Z |

## Description

Iowa Department of Transportation statewide rest area data. This layer displays alternative service locations with truck parking.
...
entity e:p594-nfrt l:"Truck Parking Locations - Alternative Service Location" t:attribution="Iowa DOT, HDR Engineering" t:url=https://data.iowa.gov/api/views/p594-nfrt

property e:p594-nfrt t:meta.view v:id=p594-nfrt v:category="Transportation & Utilities" v:averageRating=0 v:name="Truck Parking Locations - Alternative Service Location" v:attribution="Iowa DOT, HDR Engineering"

property e:p594-nfrt t:meta.view.owner v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:displayName="Iowa Department of Transportation"

property e:p594-nfrt t:meta.view.tableauthor v:id=2cmj-63jw v:profileImageUrlMedium=/api/users/2cmj-63jw/profile_images/THUMB v:profileImageUrlLarge=/api/users/2cmj-63jw/profile_images/LARGE v:screenName="Iowa Department of Transportation" v:profileImageUrlSmall=/api/users/2cmj-63jw/profile_images/TINY v:roleName=administrator v:displayName="Iowa Department of Transportation"
```
