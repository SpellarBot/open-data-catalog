...
```ls
series e:ak95-mjh9 d:2012-11-01T00:00:00.000Z t:period=12-Nov t:area_title="Adams County, WA" t:state_fips_code=53 t:state=WA t:county_name="Adams County" t:laus_area_code=CN5300100000000 t:county_fips_code=1 m:employed_level=7389 m:civilian_labor_force=8082 m:unemployment_rate=8.6 m:unemployed_level=693

series e:ak95-mjh9 d:2012-12-01T00:00:00.000Z t:period=12-Dec t:area_title="Adams County, WA" t:state_fips_code=53 t:state=WA t:county_name="Adams County" t:laus_area_code=CN5300100000000 t:county_fips_code=1 m:employed_level=7061 m:civilian_labor_force=7922 m:unemployment_rate=10.9 m:unemployed_level=861

series e:ak95-mjh9 d:2013-01-01T00:00:00.000Z t:period=13-Jan t:area_title="Adams County, WA" t:state_fips_code=53 t:state=WA t:county_name="Adams County" t:laus_area_code=CN5300100000000 t:county_fips_code=1 m:employed_level=6915 m:civilian_labor_force=7907 m:unemployment_rate=12.5 m:unemployed_level=992
```
...
property e:ak95-mjh9 t:meta.view d:2017-09-25T07:23:32.396Z v:averageRating=60 v:name="Local Area Unemployment Statistics" v:attribution="United States Department of Labor" v:attributionLink=http://stats.bls.gov/lau/laucntycur14.txt v:id=ak95-mjh9 v:category=Economics

property e:ak95-mjh9 t:meta.view.owner d:2017-09-25T07:23:32.396Z v:displayName="OCIO-Will Saunders" v:lastNotificationSeenAt=1495236575 v:profileImageUrlLarge=/api/users/h2ue-vnnt/profile_images/LARGE v:profileImageUrlSmall=/api/users/h2ue-vnnt/profile_images/TINY v:id=h2ue-vnnt v:screenName="OCIO-Will Saunders" v:profileImageUrlMedium=/api/users/h2ue-vnnt/profile_images/THUMB

property e:ak95-mjh9 t:meta.view.tableauthor d:2017-09-25T07:23:32.396Z v:displayName="OCIO-Will Saunders" v:lastNotificationSeenAt=1495236575 v:profileImageUrlLarge=/api/users/h2ue-vnnt/profile_images/LARGE v:roleName=publisher v:profileImageUrlSmall=/api/users/h2ue-vnnt/profile_images/TINY v:id=h2ue-vnnt v:screenName="OCIO-Will Saunders" v:profileImageUrlMedium=/api/users/h2ue-vnnt/profile_images/THUMB
```
