...
```ls
metric m:number_of_glass_doors p:integer l:"Number of Glass Doors"models, the total number of glass doors on the unit." t:dataTypeName=number

metric m:number_of_solid_doors p:integer l:"Number of Solid Doors"models, the total number of solid doors on the unit." t:dataTypeName=number

metric m:number_of_doors p:integer l:"Number of Doors" t:dataTypeName=number

metric m:total_volume_cu_ft l:"Volume (cu. ft.)"a refrigerator or freezer as calculated by AHAM Standard Household Refrigerators/Household Freezers (ANSI/AHAM HRF-1-2004)." t:dataTypeName=number

metric m:mixed_door_cabinet_glass_door_volume_cu_ft l:"Mixed Door Cabinet: Glass Door Volume (cu. ft.)"the volume of the glass door compartment measured in cubic feet." t:dataTypeName=number

metric m:mixed_door_cabinet_solid_door_volume_cu_ft l:"Mixed Door Cabinet: Solid Door Volume (cu. ft.)"the volume of the solid door compartment measured in cubic feet." t:dataTypeName=number

metric m:height_in l:"Height (in.)"measured in inches." t:dataTypeName=number

metric m:width_in l:"Width (in.)"easured in inches." t:dataTypeName=number

metric m:depth_in l:"Depth (in.)"easured in inches." t:dataTypeName=number

metric m:energy_use_daily_energy_consumption_kwh_day l:"Energy Use (Daily Energy Consumption) (kWh/day)"easured in kW-h, used by the unit daily." t:dataTypeName=number
